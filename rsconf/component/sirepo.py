...
#TODO(robnagler) remove when deployed to alpha
    ...
    def _jupyterhublogin(self, z):
        z.jupyterhub_enabled =  'jupyterhublogin' in set(self.j2_ctx.sirepo.feature_config.moderated_sim_types).union(
            set(self.j2_ctx.sirepo.feature_config.default_proprietary_sim_types))
