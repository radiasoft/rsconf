...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/nginx/conf.d/petshop.v4.radia.run.conf' '100fce8761c771677287b61fbc295579'
rsconf_install_access '711' 'vagrant' 'vagrant'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/nginx/conf.d/beforeother.v4.radia.run.conf' '8da64fd37ecc0383677657696d32f071'
rsconf_install_access '711' 'vagrant' 'vagrant'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/nginx/conf.d/m-petshop.v4.radia.run.conf' '093657191f8635101b0d714bb359c9b7'
rsconf_install_access '711' 'vagrant' 'vagrant'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/nginx/conf.d/other.v4.radia.run.conf' '6f8102873a82749af1a71dc0c36999eb'
rsconf_install_access '711' 'vagrant' 'vagrant'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/nginx/conf.d/requiresecure.v4.radia.run.conf' '395186fecb0a109351b14b053ca97808'
