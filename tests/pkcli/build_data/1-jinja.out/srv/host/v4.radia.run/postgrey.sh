...
rsconf_install_perl_rpm 'bivio-perl' 'bivio-perl-dev.rpm' 'bivio-perl-20220630.014024-1.x86_64'
rsconf_install_perl_rpm 'perl-Bivio' 'perl-Bivio-dev.rpm' 'perl-Bivio-20220630.013934-1.x86_64'
...
rsconf_install_file '/srv/postgrey/etc/postgrey_whitelist_clients.local' '86406802c126e44b6755fdccba715459'
}
