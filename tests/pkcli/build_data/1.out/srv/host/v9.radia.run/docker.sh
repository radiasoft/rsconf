...
rsconf_install_file '/etc/docker/tls/cert.pem' 'a5d1a82aaade1867776cbceb952aaf0c'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/docker/daemon.json' '1b44ccb50658b353b3f426c2ec35a828'
docker_main
rsconf_install_access '700' 'root' 'root'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/root/.docker/config.json' 'f446e259d84a523bc40e250980ebb4c7'
