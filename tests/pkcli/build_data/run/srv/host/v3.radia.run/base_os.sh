...
rsconf_install_file '/etc/base.rsconf' 'f771df0d08c80cd35fb1108d0ef190b1'
...
rsconf_install_access '400' 'root' 'root'
rsconf_install_file '/etc/v3.radia.run.rsconf' 'f771df0d08c80cd35fb1108d0ef190b1'
rsconf_install_access '700' 'root' 'root'
...
base_os_main() {
    ...
    rsconf_append_authorized_key 'root' 'ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIHrsQ//X6dWStcx3GSmxAuZWGlTlMCcoPthe3jLcZUHb v3.radia.run'
    if [[ ! -d /srv ]]; then
        mkdir -p /srv
        chmod 755 /srv
    fi
