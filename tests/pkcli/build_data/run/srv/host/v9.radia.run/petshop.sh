...
rsconf_install_file '/etc/nginx/conf.d/star.v4.radia.run.key' '6556f9a8df7247eedf3358c65f58ec16'
rsconf_install_file '/etc/nginx/conf.d/star.v4.radia.run.crt' '8aab07a7b220e6d696f7a057cb695d3c'
rsconf_install_access '400' 'root' 'root'
