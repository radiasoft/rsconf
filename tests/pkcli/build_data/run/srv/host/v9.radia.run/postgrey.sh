...
rsconf_install_perl_rpm 'bivio-perl' 'bivio-perl-dev.rpm' 'bivio-perl-20210302.034645-1.x86_64'
rsconf_install_perl_rpm 'perl-Bivio' 'perl-Bivio-dev.rpm' 'perl-Bivio-20211008.211133-1.x86_64'
...
rsconf_install_file '/srv/postgrey/etc/postgrey_whitelist_clients.local' 'ee96b4fd5352860a9aa49339d9ec9a9a'
}
