...
rsconf_edit_no_change_res=0 rsconf_append $'/srv/devbox_fullstackdude/jupyter/bashrc' $'export SIREPO_PKCLI_JOB_SUPERVISOR_PORT=\'3202\''
rsconf_edit_no_change_res=0 rsconf_append $'/srv/devbox_fullstackdude/jupyter/bashrc' $'export SIREPO_JOB_DRIVER_LOCAL_SUPERVISOR_URI=\'http://127.0.0.1:3202\''
rsconf_edit_no_change_res=0 rsconf_append $'/srv/devbox_fullstackdude/jupyter/bashrc' $'export SIREPO_JOB_API_SUPERVISOR_URI=\'http://127.0.0.1:3202\''
